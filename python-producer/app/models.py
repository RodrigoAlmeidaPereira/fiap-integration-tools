...
class RecipientMonthModel:
    ...
    def __init__(self, fields):
        self.reference_month = fields[self.REFERENCE_INDEX][4:]
        self.reference_year = fields[self.REFERENCE_INDEX][:4]
        self.competence_month = fields[self.COMPETENCE_INDEX][4:]
        self.competence_year = fields[self.COMPETENCE_INDEX][:4]
        ...
        self.installment_value = float(fields[self.INSTALLMENT_VALUE_INDEX].replace(",", "."))
